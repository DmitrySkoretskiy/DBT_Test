...
from
    "dbt_course"."bookings_dbt"."fct_flights" fl
    inner join "dbt_course"."bookings_dbt_snapshot"."dim_airports" aa
    ...
    inner join "dbt_course"."bookings_dbt_snapshot"."dim_airports" da 
    ...
    inner join "dbt_course"."bookings_dbt_snapshot"."dim_aircrafts" airc
    ...
    inner join "dbt_course"."bookings_dbt_snapshot"."dim_aircraft_seats" ars
